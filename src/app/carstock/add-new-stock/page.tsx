        ...
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark sm:w-full md:w-203">
          <div className="flex flex-col gap-5.5 p-6.5">
            ...
            <SelectGroupTwo
              ...
              setSelectedOption={(e) =>
                setSelectedOption({ ...selectedOption, machinery_type: e?.value })
              }
            ...
            <SelectGroupTwo
              ...
              setSelectedOption={(e) =>
                setSelectedOption({ ...selectedOption, price_range: e?.value })
              }
            ...
            <SelectGroupTwo
              ...
              setSelectedOption={(e) =>
                setSelectedOption({ ...selectedOption, vehicle_type: e?.value })
              }
            ...
            <SelectGroupTwo
              ...
              setSelectedOption={(e) =>
                setSelectedOption({ ...selectedOption, transmission: e?.value })
              }
            ...
            <SelectGroupTwo
              ...
              setSelectedOption={(e) =>
                setSelectedOption({ ...selectedOption, mileage_range: e?.value })
              }
